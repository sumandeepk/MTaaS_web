...
<table border="1" style="width:100%">
					<tr>
					<td width="20%">Cloud Id</td>
					<td width="30%">Location</td>
					<td width="30%">Total Instances</td>
					
					</tr>
</table>

		<c:forEach var="cloud" items="${clouds}">
			<form id="form1" method="get" action="ViewClouds">

				<table border="1" style="width:100%">
					<tr>
						<td width="20%"><c:out value="${cloud.cloudId}" /></td>
						<td width="30%"><c:out value="${cloud.location}" /></td>
						<td width="30%"><c:out value="${cloud.totalInstances}" /></td>
