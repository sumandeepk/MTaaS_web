							...
							<form id="form1" method="get" action="ProductDetail">
								...
								<table border="1" style="width: 100%">
									<tr>
										...
										<td width="30%"><c:out value="${instance.volume}" /></td>
										<td width="30%"><c:out value="${instance.duration}" /></td>
										<td width="30%"><c:out value="${instance.status}" /></td>
										<td width="30%"><a
											href="stopInstance.jsp?id=${instance.instanceId}&location=${instance.location}">Stop
										</a></td>
										<td width="30%"><a
											href="startInstance.jsp?id=${instance.instanceId}&location=${instance.location}">Start</a></td>
