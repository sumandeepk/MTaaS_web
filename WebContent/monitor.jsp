...
java.util.List<Datapoint> dataList  = m.monitorInstances(id, location,metric); %>
				...
				new Morris.Line({
					 ...
					 // data:'<%=dataList%>',
					  data: [
					    { Timestamp: '12:55:00', Maximum: 0.16, Minimum:0.0 , Average: 0.066 },
					    { Timestamp: '13:15:00', Maximum: 0.16, Minimum:0.0 , Average: 0.032 },
					    { Timestamp: '13:40:00', Maximum: 0.17, Minimum:0.0 , Average: 0.068 },
					    { Timestamp: '13:05:00', Maximum: 0.16, Minimum:0.0 , Average: 0.032 },
					    { Timestamp: '13:45:00', Maximum: 0.17, Minimum:0.0 , Average: 0.066 }
					  ],
